...
- `session_map.py` — reads/writes `session_map.json`, syncs window states against hook data. Per-entry validation routed through `hooks.state_files.parse_session_map_entry`; invalid/future-version entries skipped with a logged reason.
