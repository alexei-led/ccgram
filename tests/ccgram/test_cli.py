...
from ccgram.cli import _FLAG_TO_ENV, apply_args_to_env, cli

_ALL_ENV_VARS = ["CCGRAM_LOG_LEVEL", *[env for _, env in _FLAG_TO_ENV]]
...
class TestCliCommands:
    def test_version(self, runner):
        ...
        assert "ccgram" in result.output
...
class TestApplyArgsToEnv:
    def test_verbose_sets_debug(self):
        ...
        assert os.environ["CCGRAM_LOG_LEVEL"] == "DEBUG"

    def test_log_level_sets_env(self):
        apply_args_to_env(log_level="WARNING")
        assert os.environ["CCGRAM_LOG_LEVEL"] == "WARNING"
    ...
    def test_config_dir_resolved(self, tmp_path):
        ...
        assert os.environ["CCGRAM_DIR"] == str(tmp_path.resolve())
